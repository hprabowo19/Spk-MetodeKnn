    ...
    <div class='box-header'>
      ...
      <div class='box-tools'>
        <div class='input-group input-group-sm' style='width: 150px;'>
          <input type=button class='btn btn-primary' value='Tambah Kasus' onclick=\"window.location.href='?module=data&act=tambahdata';\">
        </div>
      </div>
    </div>
    <!-- /.box-header -->
...
$tampil = mysql_query("SELECT * FROM data ORDER BY id limit $posisi,$batas");
$no=$posisi+1;
while ($r=mysql_fetch_array($tampil)){
	echo "<tr>
			...
			<td>$r[bulu]</td>
			<td>$r[kuku]</td>
			<td><a href=?module=data&act=edit&id=$r[id]><img src='images/edit-icon.gif' alt='edit' /></a> &nbsp;
			<a onclick='return hapus()' href=$aksi?module=data&act=hapus&id=$r[id]><img src='images/hapus-icon.gif' alt='hapus' /></a>
			</td>
			</tr>";
		$no++;
	}
...
<h3 class='box-title'>Form Tambah Kasus</h3>
</br>
</div>
<form class='form-horizontal' name=form1 method=POST action='$aksi?module=data&act=input' id='frm'>
<div class='col-md-6'>
</br>
...
case "edit":
$edit=mysql_query("SELECT * FROM data WHERE id='$_GET[id]'");
$r=mysql_fetch_array($edit);
echo "<div class='col-md-12'>
<!-- Horizontal Form -->
<div class='box box-info'>
<div class='box-header with-border'>
<h3 class='box-title'>Form Edit Kasus</h3>
</div>
<form class='form-horizontal' name=form1 method=POST action='$aksi?module=data&act=edit' id='frm'>
