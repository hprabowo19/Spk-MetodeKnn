...
$link_halaman .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&halaman=$previous>< Sebelumnya</a> | ";
}
...
$link_halaman .= " <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&halaman=$next>Selanjutnya></a> ";
}

if (($halaman_aktif != $jmlhalaman) && ($jmlhalaman != 0))
{
$link_halaman .= " | <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&halaman=$jmlhalaman>Akhir>></a> ";
}
return $link_halaman;
}
}
